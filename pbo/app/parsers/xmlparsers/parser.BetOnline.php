 ...
 * Moneylines: Yes
 * Spreads: No
 * Totals: No (Only one as specified)
 ...
 * 
 * Pregames URL (this feed): https://api.linesfeed.info/v1/pregames/lines/pu?sport=Boxing
 * Props URL (handled in separate parser): https://api.linesfeed.info/v1/contest/lines/pu
 *
 */
...
class XMLParserBetOnline
{
    ...
    public function parseXML($a_sJSON)
    {
        ...
        if ($json != false && count($this->parsed_sport->getParsedMatchups()) >= 5)
        {
            $this->full_run = true;
