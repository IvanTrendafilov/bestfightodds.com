        ...
        <div id="page-inner-wrapper">
            <div id="page-content">
                <form name="webLink" method="get" action="" style="margin-top: 10px;">
                    Select the fight or date you want to display on your website, blog or anywhere else:  <select id="webFight" style="width: 305px;" onchange="fightSelected();"><option value="0">(select a date or fight)</option>
                        <?php
                    ...
                    <div id="webFields" style="display: none; margin-top: 25px;">
                        ...
                        <div class="links-line">Preview</div><div style="margin: 15px 0 15px 0;"><a href="https://www.proboxingodds.com"><img name="webTestImage" id="webTestImageID" alt="Preview" style="border: 0px; color: #000000; text-decoration: none; " /></a></div>
