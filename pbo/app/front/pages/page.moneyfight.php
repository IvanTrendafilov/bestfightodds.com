...
$oEvent = EventHandler::getEvent(1753);
...
if ($oEvent != null)
{
    ...
    if (CacheControl::isPageCached('tmf-' . $oEvent->getID() . '-' . strtotime($sLastChange)))
    {
        //Retrieve cached page
        $sBuffer = CacheControl::getCachedPage('tmf-' . $oEvent->getID() . '-' . strtotime($sLastChange));
        $bCached = true;
        echo '<!--C:HIT-->';
    }
