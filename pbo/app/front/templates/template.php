...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en"> 
    <head>
        ...
        <meta name="description" content="<?=isset($meta_desc) ? $meta_desc . ' ' : ''?>Boxing odds comparison service. Find and compare the latest boxing lines from the top online betting sites.">
        <meta name="keywords" content="<?=isset($meta_keywords) ? $meta_keywords . ' ' : ''?>boxing odds, boxing betting, boxing lines, wbo odds, wbo, odds, betting">
        ...
        <link rel="stylesheet" type="text/css" href="/css/pbo.min.css?v=0.3.6">
    ...
    <body>
        <script async src="/js/bfo.min.js?v=0.4.6"></script>
                ...
                <div class="flex-nav">
                    <div class="flex-nav-wrap">
                        <div class="flex-header-menu">
                            ...
                            <a href="https://www.bestfightodds.com" target="_blank" rel="noopener"><div class="header-menu-item  item-non-mobile">MMA</div></a>
                            <a href="http://twitter.com/proboxingodds" target="_blank" rel="noopener"><div class="header-menu-item">
