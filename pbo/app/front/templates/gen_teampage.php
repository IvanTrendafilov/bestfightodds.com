<div id="page-wrapper" style="max-width: 800px;">
    <div id="page-container">
        <div class="content-header team-stats-header">
            <h1 id="team-name"><?= $team->getNameAsString() ?></h1>
        </div>
                        ...
                        <tbody>
                            ...
                            <?php foreach ($matchups as $matchup) : ?>
                                ...
                                <tr class="event-header item-mobile-only-row">
                                    <td colspan="8" scope="row"><a href="/events/<?= $matchup['event']->getEventAsLinkString() ?>"><?= $matchup['event_date'] ?></a></td>
                                </tr>
                                <?php if ($matchup['team1_low'] != null && $matchup['event'] != null) : ?>
                                    ...
                                    <tr>
                                        ...
                                        <td class="item-non-mobile" style="padding-left: 20px; color: #767676"></td>
                                    </tr>
