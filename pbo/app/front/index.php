 ...
 *   PAGE_OVERRIDE_TITLE - Page title. Will be in the format "ProBoxingOdds.com - <overridden_title>"
...
if (isset($_GET['p']))
{
    ...
    switch ($_GET['p'])
    {
        ...
        case 'fighter':
            ...
            if ($oFighter != null)
            {
                define('PAGE_OVERRIDE_TITLE', $oFighter->getNameAsString() . '\'s Boxing Odds History');
        ...
        case 'event':
            ...
            if ($oEvent != null)
            {
                define('PAGE_OVERRIDE_TITLE', 'Boxing Odds for ' . date_create($oEvent->getDate())->format('F dS'));
                define('PAGE_OVERRIDE_DESCRIPTION', 'Odds & betting lines for ' . date_create($oEvent->getDate())->format('F dS'));
                define('PAGE_OVERRIDE_KEYWORDS', '');
            }
            break;
        default:
    }
