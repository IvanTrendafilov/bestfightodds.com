    ...
    <body>
        ...
        <div class="header">
                ...
                <div class="header-menu-wrapper">
                        ...
                        <a href="https://www.proboxingodds.com" target="_blank"><div class="header-menu-item  item-non-mobile <?php echo CURRENT_PAGE == 'links' ? ' header-menu-selected ' : ''; ?> " style="padding-right: 3px;">Boxing<span style="font-size: 9px; color: #ff0000; padding-left: 3px; vertical-align: top;">New</span> </div></a>
