                                ...
                                if (sizeof($aFights) > 0)
                                {
                                    ...
                                    foreach ($aFights as $oFight)
                                    {
                                        echo '<tr>
                                                ...
                                                <td class="content-button-cell"><div class="p-alerts-add" id="p-alerts-add-' . $oFight->getID() . '"><input type="submit" value="Add alert" onclick="return addAlertInline(' . $oFight->getID() . ')"></div></td>
                                            </tr>';
                                        $bOddRow = !$bOddRow;
                                    }
                                    echo '</table>';
