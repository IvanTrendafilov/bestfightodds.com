    ...
    else
    {
        ...
        foreach ($aFights as $oFight)
        {
            ...
            for ($iX = 1; $iX <= 2; $iX++)
            {
                ...
                foreach ($aFightOdds as $oFightOdds)
                {
                    ...
                    foreach ($aOldFightOdds as $oOldFightOdds)
                    {
                        ...
                        if ($oOldFightOdds->getBookieID() == $iCurrentOperatorID)
                        {
                            ...
                            {
                                echo '<td><a href="#" onclick="return sH(this, ' . $oFightOdds->getBookieID() . ',' . $iX . ',' . $oFightOdds->getFightID() . ');"><span id="oddsID' . $iCellCounter++ . '" ' . $sClassName . '>' . $oFightOdds->getFighterOddsAsString($iX) . '</span><img src="/img/up.gif" bfo-cdate="' . $oFightOdds->getDate() . '" alt="" /></a></td>';
                            }
                            else if ($oFightOdds->getFighterOdds($iX) < $oOldFightOdds->getFighterOdds($iX))
                            {
                                echo '<td><a href="#" onclick="return sH(this, ' . $oFightOdds->getBookieID() . ',' . $iX . ',' . $oFightOdds->getFightID() . ');"><span id="oddsID' . $iCellCounter++ . '" ' . $sClassName . '>' . $oFightOdds->getFighterOddsAsString($iX) . '</span><img src="/img/down.gif" bfo-cdate="' . $oFightOdds->getDate() . '" alt="" /></a></td>';
                            }
                            else
                            {
                ...
                if ($iPropCount > 0)
                {
                    echo '<a href="#" onclick="return tPR(\'' . $oFight->getID() . '\', \'exp-' . $oFight->getID() . '\');">' . $iPropCount . '<img src="/img/exp.gif" class="exp-img" id="exp-' . $oFight->getID() . '-' . $iX . '" alt="Prop bets" /></a>';
                }
                echo '</td>';
            ...
            if (count($aPropTypes) > 0)
            {
                ...
                foreach ($aPropTypes as $oPropType)
                {
                    ...
                    for ($iX = 1; $iX <= 2; $iX++)
                    {
                            ...
                            foreach ($aOldPropOdds as $oOldPropOdds)
                            {
                                ...
                                if ($oOldPropOdds->getBookieID() == $iCurrentOperatorID)
                                {
                                    ...
                                    if (($iX == 1 ? $oPropOdds->getPropOddsAsString() : $oPropOdds->getNegPropOddsAsString()) != '-99999')
                                    {
                                        ...
                                        {
                                            echo '<a href="#" onclick="return sHp(this, ' . $oPropOdds->getBookieID() . ',' . $iX . ',' . $oPropOdds->getMatchupID() . ',' . $oPropOdds->getPropTypeID() . ',' . $oPropOdds->getTeamNumber() . ');"><span id="oddsID' . $iCellCounter++ . '" ' . $sClassName . '>' . ($iX == 1 ? $oPropOdds->getPropOddsAsString() : $oPropOdds->getNegPropOddsAsString()) . '</span><img src="/img/up.gif" bfo-cdate="' . $oPropOdds->getDate() . '" alt="" /></a>';
                                        }
                                        else if ($iCompareOddsNew < $iCompareOddsOld)
                                        {
                                            echo '<a href="#" onclick="return sHp(this, ' . $oPropOdds->getBookieID() . ',' . $iX . ',' . $oPropOdds->getMatchupID() . ',' . $oPropOdds->getPropTypeID() . ',' . $oPropOdds->getTeamNumber() . ');"><span id="oddsID' . $iCellCounter++ . '" ' . $sClassName . '>' . ($iX == 1 ? $oPropOdds->getPropOddsAsString() : $oPropOdds->getNegPropOddsAsString()) . '</span><img src="/img/down.gif" bfo-cdate="' . $oPropOdds->getDate() . '" alt="" /></a>';
                                        }
                                        else
                                        {
                        ...
                        {
                            echo '<td class="button-cell"><a href="#" onclick="return sIp(this,' . $iX . ',' . $oPropOdds->getMatchupID() . ', ' . $oPropOdds->getPropTypeID() . ',' . $oPropOdds->getTeamNumber() . ');"><img src="/img/graph.gif" class="small-button" alt="Prop betting line movement" title="Prop betting line movement" /></a></td>';
                        }
                        else
                        {
                            echo '<td class="button-cell"><img src="/img/nograph.gif" class="small-button" alt="No index graph available" /></td>';
