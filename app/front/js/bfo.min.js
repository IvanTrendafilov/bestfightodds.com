...
function createMChart(t,e,a){$.get("/api?f=ggd&b="+t+"&m="+a+"&p="+e,function(t){createChart($.parseJSON(notIn(t)))})}function createMIChart(t,e){$.get("/api?f=ggd&m="+t+"&p="+e,function(t){createChart($.parseJSON(notIn(t)))})}function createPChart(t,e,a,n,i){$.get("/api?f=ggd&b="+t+"&m="+e+"&p="+a+"&pt="+n+"&tn="+i,function(t){createChart($.parseJSON(notIn(t)))})}function createPIChart(t,e,a,n){$.get("/api?f=ggd&m="+t+"&p="+e+"&pt="+a+"&tn="+n,function(t){createChart($.parseJSON(notIn(t)))})}function createEPChart(t,e,a,n){$.get("/api?f=ggd&b="+e+"&e="+t+"&p="+a+"&pt="+n,function(t){createChart($.parseJSON(notIn(t)))})}function createEPIChart(t,e,a){$.get("/api?f=ggd&e="+t+"&p="+e+"&pt="+a,function(t){createChart($.parseJSON(notIn(t)))})}function createChart(t){Highcharts.setOptions({global:{useUTC:!1}}),$("#chart-area").highcharts({chart:{type:"line",style:{fontFamily:"'Roboto', Arial, sans-serif"},marginTop:18},credits:{enabled:!1},legend:{enabled:!1},colors:["#393B42"],title:{text:"",style:{color:"#272727",fontSize:"12px",fontWeight:"bold"}},xAxis:{type:"datetime",dateTimeLabelFormats:{month:"%e. %b",year:"%b"},title:{text:""},tickPixelInterval:50},yAxis:{title:{text:""},labels:{formatter:function(){return this.value>1?2==oddsType?Highcharts.numberFormat(this.value,2):4==oddsType?(odds=5*Math.round(oneDecToML(this.value)/5),singleMLToFractional(odds)):oneDecToML(this.value):""}},tickPixelInterval:50},tooltip:{formatter:function(){var t=this.series.xData.indexOf(this.x),e=(this.series.yData[t-1],"");"undefined"!=typeof this.series.yData[t-1]&&(this.series.yData[t-1]<this.y?e='<span style="color: #4BCA02">▲</span>':this.series.yData[t-1]>this.y&&(e='<span style="color: #E93524">▼</span>'));var a;return 2==oddsType?a=Highcharts.numberFormat(this.y,2):4==oddsType?(odds=5*Math.round(oneDecToML(this.y)/5),a=singleMLToFractional(odds)):a=oneDecToML(this.y),'<span style="color: #666; font-weight: bold; font-size: 11px">'+Highcharts.dateFormat("%a %d. %b %H:%M",this.x)+"</span><br/>"+this.series.name+": <b>"+a+"</b>"+e+"<br/>"},style:{fontSize:"12px"}},plotOptions:{series:{step:"left",animation:!1},line:{turboThreshold:1500,lineWidth:1.75,marker:{enabled:!1,fillColor:"#666",radius:2},states:{hover:{lineWidth:1.75}},dataLabels:{shape:"callout",defer:!1,enabled:!0,formatter:function(){return 0===this.point.index||this.series.chart.series[0].points.length-1==this.point.index?2==oddsType?'<span style="margin-left: 4px; margin-right: 4px;">'+Highcharts.numberFormat(this.y,2)+"</span>":4==oddsType?(odds=5*Math.round(oneDecToML(this.y)/5),'<span style="margin-left: 4px; margin-right: 4px;">'+singleMLToFractional(odds)+"</span>"):'<span style="margin-left: 4px; margin-right: 4px;">'+oneDecToML(this.y)+"</span>":null},backgroundColor:"rgba(69, 69, 69, 0.8)",padding:3,style:{textShadow:0,fontSize:"11px",color:"#fff",fontWeight:"normal"},y:-8,overflow:"none",crop:!1,useHTML:!0}}},series:t})}$(function(){function t(t){for(var e=t[0].data,a=[],n=0;n<e.length;n++)a.push(e[n][0]);$("#event-swing-container").highcharts({title:{text:""},legend:{enabled:!1},chart:{animation:!1,type:"bar",style:{fontFamily:"'Roboto', Arial, sans-serif",color:"#1a1a1a",fontSize:"10px",fontWeight:"500"}},xAxis:{categories:a,labels:{overflow:"justify",style:{fontSize:"10px",fontWeight:"500",align:"left"}}},yAxis:{title:{text:"Line change (%)",align:"high"}},tooltip:{valueSuffix:" %"},plotOptions:{bar:{dataLabels:{formatter:function(){return this.y>0?"+"+this.y+"%":this.y+"%"},style:{fontFamily:"'Roboto', Arial, sans-serif",color:"#4d4d4d",fontSize:"11px",fontWeight:"500"},enabled:!0,crop:!1,overflow:"none",allowOverlap:!0}},series:{animation:{duration:200}}},credits:{enabled:!1},series:t})}if(document.getElementById("event-swing-container")){var e=$.parseJSON($("#event-swing-container").attr("data-moves"));t(e)}}),$(function(){function t(){$("#event-outcome-container").highcharts({chart:{type:"bar"},title:{text:""},xAxis:[{categories:["Jon Jones","Anderson Silva","Matt Hammill","Pete Sell","Matt Serra"],reversed:!1,labels:{step:1}},{opposite:!0,reversed:!1,categories:["Royce Gracie","Mike Van Arsdale","CM Punk","Brock Lesnar","Demetrious Johson"],linkedTo:0,labels:{step:1}}],yAxis:{min:0,title:{text:""}},tooltip:{pointFormat:'<span style="color:{series.color}">{series.name}</span>: <b>{point.y}</b> ({point.percentage:.0f}%)<br/>',shared:!0},plotOptions:{bar:{stacking:"percent",dataLabels:{formatter:function(){return this.series.name},enabled:!0,color:Highcharts.theme&&Highcharts.theme.dataLabelsColor||"white",style:{fontSize:"10px",textShadow:"0 0 2px black"}},animation:!1}},series:[{name:"Decision",data:[7,3,4,7,9],color:"#404040"},{name:"TKO",data:[4,2,3,4,1],color:"#909090"},{name:"Submission",data:[6,4,4,6,5],color:"#c0c0c0"},{name:"Draw",data:[1,1,1,1,1],color:"#a10000"},{name:"Submission",data:[5,3,4,7,2],color:"#c0c0c0"},{name:"TKO",data:[2,2,3,2,1],color:"#909090"},{name:"Decision",data:[3,4,4,2,5],color:"#404040"}]})}document.getElementById("event-outcome-container")&&t()}),$(function(){$(".event-swing-picker").click(function(){for(var t,e=$(this).attr("data-li"),a=$("#event-swing-container").highcharts(),n=a.series,i=n.length;i--;)t=n[i],i!=e&&t.hide();n[e].show();for(var r=a.series[e].data,o=[],s=0;s<r.length;s++)o.push(r[s].name);return a.xAxis[0].setCategories(o),$("#event-swing-container").css("height",60+18*r.length),a.setSize(a.chartWidth,60+18*r.length),a.redraw(),!1})}),$(function(){function t(){var n,i,r,o,s,l,c=+new Date,h=e.length;for(n=0;h>n;n+=1)if(i=$(e[n]),r=i.data("sparkline"),o=r.split("; "),s=$.map(o[0].split(", "),parseFloat),l={},o[1]&&(l.type=o[1]),i.highcharts("SparkLine",{series:[{data:s,pointStart:1}],chart:l}),a+=1,new Date-c>500){e.splice(0,n+1),setTimeout(t,0);break}}Highcharts.SparkLine=function(t,e){var a={chart:{renderTo:t.chart&&t.chart.renderTo||this,backgroundColor:null,borderWidth:0,type:"area",margin:[3,0,5,2],width:50,height:32,className:"chart-spark",events:{click:function(t){var e=$.parseJSON($("#"+this.container.id).closest("td").attr("data-li")),a=$("#"+this.container.id).closest("tr").next("tr").find("th.oppcell").text(),n=$("#team-name").text()+' <span style="font-weight: normal;">(vs. '+a+") &#150; Mean odds";chartCC(),createMIChart(e[0],e[1]),chartSC(n,t.clientX,t.clientY)}},style:{overflow:"visible"},skipClone:!0},colors:["#000"],title:{text:""},credits:{enabled:!1},xAxis:{labels:{enabled:!1},title:{text:null},startOnTick:!1,endOnTick:!1,tickPositions:[]},yAxis:{endOnTick:!1,startOnTick:!1,labels:{enabled:!1},title:{text:null},tickPositions:[0]},legend:{enabled:!1},tooltip:{enabled:!1},plotOptions:{series:{threshold:null,animation:!1,lineWidth:.65,states:{hover:{enabled:!1}},shadow:!1,events:{click:function(t){var e=$.parseJSON($("#"+this.chart.container.id).closest("td").attr("data-li")),a=$("#"+this.chart.container.id).closest("tr").next("tr").find("th.oppcell").text(),n=$("#team-name").text()+' <span style="font-weight: normal;">(vs. '+a+") &#150; Mean odds";chartCC(),createMIChart(e[0],e[1]),chartSC(n,t.clientX,t.clientY)}},marker:{enabled:!1},fillColor:"#e9ebed"}}};return t=Highcharts.merge(a,t),new Highcharts.Chart(t,e)};var e=(+new Date,$("td[data-sparkline]")),a=(e.length,0);t()});