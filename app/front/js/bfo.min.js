...
function hideArrows(){$(".ard").css("display","none"),$(".aru").css("display","none"),window.setTimeout(function(){$(".ard").css("display","inline-block"),$(".aru").css("display","inline-block")},0)}var storedOdds=[],oddsType=1,parlayMode=!1,parlay=[],autoRefresh=!1,refreshID=null,refreshOpenProps={},scrollCache=[],scrollX=0,scrollCaptain=null,shareVisible=!1;chartCC=function(){$("#chart-area").empty(),$("#chart-link").hide(),$("#chart-window").height("228")},chartSC=function(e,t,a){null!=(url=e.match('href="([^"]*)"'))&&null!=(bookie=e.match(">([^<]*)</a>"))&&($("#chart-link").html("Bet this line at "+bookie[1]),$("#chart-link").show(),$("#chart-link").parent().attr("href","https://www.bestfightodds.com"+url[1]),$("#chart-window").height("260")),$("#chart-window").removeClass("is-visible"),$("#chart-window").addClass("no-transition"),getComputedStyle($("#chart-window")[0]).display,$("#chart-window")[0].offsetHeight,$("#chart-header").find("div").html(e),yorigin="top",xorigin="left","1px"!=$("#chart-window").css("min-width")&&(setxcord=t+8,setycord=a+8,t+$("#chart-window").width()>=$(window).width()&&(setxcord=t-$("#chart-window").width(),xorigin="right"),a+$("#chart-window").height()>=$(window).height()&&(setycord=a-$("#chart-window").height(),yorigin="bottom"),$("#chart-window").css({left:setxcord,top:setycord,"transform-origin":yorigin+" "+xorigin})),getComputedStyle($("#chart-window")[0]).display,$("#chart-window")[0].offsetHeight,$("#chart-window").removeClass("no-transition"),$("#chart-window").addClass("is-visible")},alertSW=function(e,t,a){$("#alert-window").removeClass("is-visible"),$("#alert-window").addClass("no-transition"),getComputedStyle($("#alert-window")[0]).display,$("#alert-window")[0].offsetHeight,$("#alert-result").removeClass("success error"),$("#alert-form").find("input").removeClass("success error"),$("#alert-odds").val(e.bestodds),$(".alert-result").removeClass("success error"),$(".alert-result").text(""),$("#alert-form").find("[name=tn]").val(e.opts[1]),$("#alert-form").find("[name=m]").val(e.opts[0]),$("#alert-header").find("div").html('Add alert:<span style="font-weight: normal;"> '+e.teamtitle+"</span>"),yorigin="top",xorigin="right",null!==Cookies.get("bfo_alertmail")&&$("#alert-mail").val(Cookies.get("bfo_alertmail")),"1px"!=$("#alert-window").css("min-width")&&(setxcord=t+8,setycord=a+8,setxcord=t-$("#alert-window").width(),xorigin="right",a+$("#alert-window").height()>=$(window).height()&&(setycord=a-$("#alert-window").height(),yorigin="bottom"),$("#alert-window").css({left:setxcord,top:setycord,"transform-origin":yorigin+" "+xorigin})),getComputedStyle($("#alert-window")[0]).display,$("#alert-window")[0].offsetHeight,$("#alert-window").removeClass("no-transition"),$("#alert-window").addClass("is-visible")},lO=function(e,t){$.get("/ajax/ajax.LinkOut.php",{operator:e,event:t})},addToParlay=function(e){if(null!==e){if(parlay.length>=25)return!1;tmpArr=[],tmpArr.ml=$(e).find("span").find("span").first().text(),tmpArr.name=$(e).closest("tr").find("th").text(),tmpArr.ref=$(e).find("span").find("span").first().attr("id").substring(3),found=!1,foundEl=null;for(var t=0;t<parlay.length;t++)parlay[t].ref==tmpArr.ref&&(foundEl=t,found=!0);found?parlay.splice(foundEl,1):parlay.push(tmpArr)}else if(0===parlay.length)return!1;if(0===parlay.length)return $("#parlay-area").html("Click on a line to add it to your parlay"),$("#parlay-header").html("Parlay"),!1;tmpText="",pvalue=1;for(var t=0;t<parlay.length;t++){var a="";if(null!=storedOdds[parlay[t].ref]){switch(oddsType){case 1:a=storedOdds[parlay[t].ref];break;case 2:a=parseFloat(singleMLToDecimal(storedOdds[parlay[t].ref])).toFixed(2);break;case 3:a=singleDecimalToAmount(singleMLToDecimal(storedOdds[parlay[t].ref]),$("#format-amount-box1").val())}pvalue*=singleMLToDecimal(storedOdds[parlay[t].ref])}else{switch(oddsType){case 1:a=document.getElementById("oID"+parlay[t].ref).innerHTML;break;case 2:a=parseFloat(singleMLToDecimal(document.getElementById("oID"+parlay[t].ref).innerHTML)).toFixed(2);break;case 3:a=singleDecimalToAmount(singleMLToDecimal(document.getElementById("oID"+parlay[t].ref).innerHTML),$("#format-amount-box1").val())}pvalue*=singleMLToDecimal(document.getElementById("oID"+parlay[t].ref).innerHTML)}tmpText+='<span>»</span> <span style="font-weight: 500">'+parlay[t].name+"</span> "+a+"<br />"}switch(dispValue="",oddsType){case 1:1==parlay.length?dispValue=parlay[0].ml:dispValue=oneDecToML(pvalue);break;case 2:dispValue=Math.round(100*pvalue)/100;break;case 3:dispValue=singleDecimalToAmount(pvalue,$("#format-amount-box1").val())}return $("#parlay-area").html(tmpText),$("#parlay-header").html("Parlay: "+dispValue),!1},oddsToMoneyline=function(){1!=oddsType&&(storedOdds.length>0&&$('[id^="oID"]').each(function(){this.innerHTML=storedOdds[this.id.substring(3)]}),oddsType=1)},oddsToDecimal=function(){2!=oddsType&&(1!=oddsType&&oddsToMoneyline(),1==oddsType&&0===storedOdds.length&&$('[id^="oID"]').each(function(){storedOdds[this.id.substring(3)]=this.innerHTML}),$('[id^="oID"]').each(function(){this.innerHTML=parseFloat(singleMLToDecimal(this.innerHTML)).toFixed(2)}),oddsType=2)},oddsToAmount=function(e){var t;t=null===e?$("#format-amount-box1").val():e,isNaN(t)||0>t||(oddsToDecimal(),$('[id^="oID"]').each(function(){var e=parseFloat(this.innerHTML);this.innerHTML="$"+Math.round(t*e-t)}),oddsType=3,Cookies.set("bfo_odds_type",3,{expires:999}),Cookies.set("bfo_risk_amount",t,{expires:999}),$("#format-toggle-text").find("span").first().next().html("$"+t+"  &#9660;"),$("#format-amount-box1").val(t),parlayMode&&addToParlay(null))},oddsToFraction=function(){4!=oddsType&&(1!=oddsType&&oddsToMoneyline(),1==oddsType&&0===storedOdds.length&&$('[id^="oID"]').each(function(){storedOdds[this.id.substring(3)]=this.innerHTML}),$('[id^="oID"]').each(function(){this.innerHTML=singleMLToFractional(this.innerHTML)}),oddsType=4)},singleMLToDecimal=function(e){return"-"==String(e).substring(0,1)?(oddsFloat=parseFloat(String(e).substring(1,String(e).length)),oddsFloat=Math.round(1e5*(100/oddsFloat+1))/1e5,oddsFloat.toString()):"+"==String(e).substring(0,1)?(oddsFloat=parseFloat(String(e).substring(1,String(e).length)),oddsFloat=Math.round(1e5*(oddsFloat/100+1))/1e5,oddsFloat.toString()):"error"},singleMLToFractional=function(e){function t(e,t){var a,s;if(t>e)a=t,s=e;else if(e>t)a=e,s=t;else if(e==t)return e;for(;;){if(0==s)return a;var i=s;s=a%s,a=i}}function a(e,a){var s=new Array(2),i=t(e,a);return s[0]=e/i,s[1]=a/i,s}e=5*Math.round(e/5);var s,i,r,o=parseFloat(e);0>o?(r=-1*o,i=100):o>0&&(r=100,i=o);var n=a(i,r);return i=n[0],r=n[1],s=i/r+1,""+i+"/"+r},oneDecToML=function(e){return e>=2?"+"+Math.round(100*(e-1)):2>e?""+Math.round(-100/(e-1)):"error"},singleDecimalToAmount=function(e,t){var a;if(a=null===t?document.getElementById("format-amount-box1").value:t,isNaN(a)||0>a)return"";var s=new String(Math.round(a*e-a));return"$"+s},setOddsType=function(e){switch(e){case 1:oddsToMoneyline(),Cookies.set("bfo_odds_type",1,{expires:999}),$("#format-toggle-text").find("span").first().next().html("Moneyline &#9660;");break;case 2:oddsToDecimal(),Cookies.set("bfo_odds_type",2,{expires:999}),$("#format-toggle-text").find("span").first().next().html("Decimal &#9660;");break;case 3:$("#format-toggle-text").find("span").first().next().html("Amount &#9660;"+$("#format-amount-box1").html());break;case 4:oddsToFraction(),Cookies.set("bfo_odds_type",4,{expires:999}),$("#format-toggle-text").find("span").first().next().html("Fractional &#9660;")}parlayMode&&addToParlay(null)},notIn=function(e){var t,a,s,i,r,o,n,l="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=",d="",c=0;for(e=e.replace(/[^A-Za-z0-9\+\/\=]/g,"");c<e.length;)i=l.indexOf(e.charAt(c++)),r=l.indexOf(e.charAt(c++)),o=l.indexOf(e.charAt(c++)),n=l.indexOf(e.charAt(c++)),t=i<<2|r>>4,a=(15&r)<<4|o>>2,s=(3&o)<<6|n,d+=String.fromCharCode(t),64!=o&&(d+=String.fromCharCode(a)),64!=n&&(d+=String.fromCharCode(s));for(var h="",f=0,p=c1=c2=0;f<d.length;)p=d.charCodeAt(f),128>p?(h+=String.fromCharCode(p),f++):p>191&&224>p?(c2=d.charCodeAt(f+1),h+=String.fromCharCode((31&p)<<6|63&c2),f+=2):(c2=d.charCodeAt(f+1),c3=d.charCodeAt(f+2),h+=String.fromCharCode((15&p)<<12|(63&c2)<<6|63&c3),f+=3);var u,$,m,g="!\"#$%&'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~",y=new String,w=g.length;for(u=0;u<h.length;u++)m=h.charAt(u),$=g.indexOf(m),$>=0&&(m=g.charAt(($+w/2)%w)),y+=m;return y},getElementsByClassName=function(e,t){var a=arguments[2]||new Array,s=new RegExp("\\b"+e+"\\b","g");s.test(t.className)&&a.push(t);for(var i=0;i<t.childNodes.length;i++)getElementsByClassName(e,t.childNodes[i],a);return a},$(document).ready(function(){initPage(),"none"!=$("#auto-refresh-container").css("display")&&(null===Cookies.get("bfo_autorefresh")||isNaN(Cookies.get("bfo_autorefresh"))||"0"!=Cookies.get("bfo_autorefresh")?($("#afSelectorOff").removeClass("list-checked"),$("span",$("#afSelectorOff")).css("display","none"),toggleRefresh(!0),$("#afSelectorOn").addClass("list-checked"),$("span",$("#afSelectorOn")).css("display","inline-block")):($("#afSelectorOn").removeClass("list-checked"),$("span",$("#afSelectorOn")).css("display","none"),toggleRefresh(!1),$("#afSelectorOff").addClass("list-checked"),$("span",$("#afSelectorOff")).css("display","inline-block"))),$("#formatSelector1").click(function(){$('[id^="formatSelector"]').each(function(){$(this).removeClass("list-checked"),$("span",this).css("display","none")}),setOddsType(1),$(this).addClass("list-checked"),$("span",this).css("display","inline-block")}),$("#formatSelector2").click(function(){$('[id^="formatSelector"]').each(function(){$(this).removeClass("list-checked"),$("span",this).css("display","none")}),setOddsType(2),$(this).addClass("list-checked"),$("span",this).css("display","inline-block")}),$("#formatSelector3").click(function(){$('[id^="formatSelector"]').each(function(){$(this).removeClass("list-checked"),$("span",this).css("display","none")}),oddsToAmount($("#format-amount-box1").val()),$(this).addClass("list-checked"),$("span",this).css("display","inline-block")}),$("#formatSelector4").click(function(){$('[id^="formatSelector"]').each(function(){$(this).removeClass("list-checked"),$("span",this).css("display","none")}),setOddsType(4),$(this).addClass("list-checked"),$("span",this).css("display","inline-block")}),$("#format-amount-box1").change(function(){$('[id^="formatSelector"]').each(function(){$(this).removeClass("list-checked"),$("span",this).css("display","none")}),oddsToAmount($("#format-amount-box1").val()),$("#formatSelector3").addClass("list-checked"),$("span",$("#formatSelector3")).css("display","inline-block")}),$("#format-amount-box1").keyup(function(e){13==e.keyCode&&$("#format-amount-box1").change()}),$("#afSelectorOn").click(function(){$("#afSelectorOff").removeClass("list-checked"),$("span",$("#afSelectorOff")).css("display","none"),toggleRefresh(!0),$("#afSelectorOn").addClass("list-checked"),$("span",$("#afSelectorOn")).css("display","inline-block")}),$("#afSelectorOff").click(function(){$("#afSelectorOn").removeClass("list-checked"),$("span",$("#afSelectorOn")).css("display","none"),toggleRefresh(!1),$("#afSelectorOff").addClass("list-checked"),$("span",$("#afSelectorOff")).css("display","inline-block")}),$("#parlay-mode-box").click(function(){if(parlay=[],"undefined"==typeof $(this).data("toggled")&&$(this).data("toggled",!1),$(this).data("toggled",!$(this).data("toggled")),$(this).data("toggled")){$("#parlay-mode-box").find(".bfo-check-box").addClass("checked"),parlayMode=!0,$("#parlay-window").addClass("is-visible");var e="ontouchstart"in window||navigator.msMaxTouchPoints>0;e?$("#parlay-window").css({left:5,top:5}):$(document).on("mousemove",function(e){$("#parlay-window").css({left:e.clientX+8,top:e.clientY+8})})}else $("#parlay-mode-box").find(".bfo-check-box").removeClass("checked"),parlayMode=!1,$(document).off("mousemove"),$("#parlay-window").removeClass("is-visible"),$("#parlay-area").html("Click on a line to add it to your parlay"),$("#parlay-header").html("Parlay")}),$("#search-box1").on("mousedown",function(e){$(this).css("color","#fff"),$(this).focus(),$(this).off("mousedown")}),$("#alert-form").submit(function(e){e.preventDefault();var t=$("#alert-form :input,select"),a={};t.each(function(){a[this.name]=$(this).val()}),$("#alert-submit")[0].disabled=!0,$(".alert-result").removeClass("success error"),$(e.target).find("input").removeClass("success error"),$(".alert-loader").css("display","inline-block"),$.get("api?f=aa",{alertFight:a.m,alertFighter:a.tn,alertBookie:a["alert-bookie"],alertMail:a["alert-mail"],alertOdds:a["alert-odds"],alertOddsType:oddsType},function(t){$(".alert-loader").css("display","none");var s="";switch(t){case"1":s="✓ Alert added",Cookies.set("bfo_alertmail",a["alert-mail"],{expires:999});break;case"2":s="✓ Alert already exists";break;case"-1":case"-2":case"-3":s="x Error: Missing values ("+t+")";break;case"-4":s="x Invalid e-mail",$("#alert-mail").addClass("error");break;case"-5":s="x Invalid odds format",$("#alert-odds").addClass("error");break;case"-6":s="x Alert limit reached (50)";break;case"-7":s="x Odds already reached",$("#alert-odds").addClass("error");break;default:s="x Unknown error"}$(".alert-result").addClass(t>=1?"success":"error"),$(".alert-result").text(s),$(e.target).find('input[type="submit"]').prop("disabled",!1)})}),$("#alert-form-il .button").on("click",function(e){e.preventDefault();var t=$("#alert-form-il :input,select"),a={};t.each(function(){a[this.name]=$(this).val()});var s=$(this);s[0].disabled=!0,s.prevAll(".alert-result").removeClass("success error"),$("#alert-mail-il").removeClass("success error"),s.prevAll(".alert-result-il").text(""),s.prevAll(".alert-loader").css("display","inline-block"),$.get("/api?f=aa",{alertFight:$(this).data("mu"),alertFighter:"1",alertBookie:a["alert-bookie-il"],alertMail:a["alert-mail-il"],alertOdds:"-9999",alertOddsType:oddsType},function(e){s.prevAll(".alert-loader").css("display","none");var t="";switch(e){case"1":t="✓ Alert added",Cookies.set("bfo_alertmail",a["alert-mail-il"],{expires:999});break;case"2":t="✓ Alert already exists";break;case"-1":case"-2":case"-3":t="x Error: Missing values ("+e+")";break;case"-4":t="x Invalid e-mail",$("#alert-mail-il").addClass("error");break;case"-5":t="x Invalid odds format";break;case"-6":t="x Alert limit reached (50)";break;case"-7":t="x Odds already reached";break;default:t="x Unknown error"}s.prevAll(".alert-result-il").addClass(e>=1?"success":"error"),s.prevAll(".alert-result-il").text(t),0>=e&&(s[0].disabled=!1)})}),$("span.teamPercChange").on("click",function(e){var t=$.parseJSON($(this).attr("data-li")),a=$(this).closest("tr").next("tr").find("th.oppcell").text(),s=$("#team-name").text()+' <span style="font-weight: normal;">(vs. '+a+") &#150; Mean odds";return chartCC(),createMIChart(t[0],t[1]),chartSC(s,e.clientX,e.clientY),!1})}),initPage=function(){if(oddsType=1,storedOdds=[],null!==Cookies.get("bfo_odds_type")&&!isNaN(Cookies.get("bfo_odds_type"))){switch(cOddsType=parseInt(Cookies.get("bfo_odds_type")),cOddsType){case 1:$("#format-toggle-text").find("span").first().next().html("Moneyline &#9660;");break;case 2:$("#format-toggle-text").find("span").first().next().html("Decimal &#9660;"),oddsToDecimal();break;case 3:$("#format-toggle-text").find("span").first().next().html(" $"+Cookies.get("bfo_risk_amount")+" &#9660;"),$("#format-amount-box1").find("span").first().next().html(Cookies.get("bfo_risk_amount")),oddsToAmount(Cookies.get("bfo_risk_amount"));break;case 4:$("#format-toggle-text").find("span").first().next().html("Fractional &#9660;"),oddsToFraction()}$('[id^="formatSelector"]').each(function(){$(this).removeClass("list-checked"),$("span",this).css("display","none")}),$("#formatSelector"+cOddsType).addClass("list-checked"),$("span",$("#formatSelector"+cOddsType)).css("display","inline-block")}$("div.table-scroller").each(function(){scrollCache.push([$(this),$("table",$(this)),$(this).prev().prev(".table-inner-shadow-left"),$(this).prev(".table-inner-shadow-right")]),$.each(scrollCache,function(e,t){t[2].data("scrollLeftVis",!1),t[3].data("scrollRightVis",!0)})}),$("td.prop-cell").find("a").on("click",function(){return matchup_id=$(this).attr("data-mu"),"undefined"==typeof $(this).data("toggled")&&$(this).data("toggled",!1),$(this).data("toggled",!$(this).data("toggled")),$("[data-mu="+matchup_id+"]").data("toggled",$(this).data("toggled")),$(this).data("toggled")?(navigator.appName.indexOf("Microsoft")>-1&&-1==navigator.appVersion.indexOf("MSIE 10.0")?($(this).closest("tr").next("tr.odd").andSelf("tr.odd").nextUntil("tr.even").css("display","block"),$("#mu-"+matchup_id).nextUntil("tr.even").css("display","block")):($(this).closest("tr").next("tr.odd").andSelf("tr.odd").nextUntil("tr.even").css("display","table-row"),$("#mu-"+matchup_id).nextUntil("tr.even").css("display","table-row")),$("[data-mu='"+matchup_id+"']").find(".exp-ard").addClass("exp-aru").removeClass("exp-ard"),refreshOpenProps[matchup_id]=!0):($(this).closest("tr").next("tr.odd").andSelf("tr.odd").nextUntil("tr.even").css("display","none"),$("#mu-"+matchup_id).nextUntil("tr.even").css("display","none"),$("[data-mu='"+matchup_id+"']").find(".exp-aru").addClass("exp-ard").removeClass("exp-aru"),refreshOpenProps[matchup_id]=!1),!1}),$("tr.eventprop th").find("a").on("click",function(e){e.preventDefault(),event_id=$(this).attr("data-mu"),$(".prop-cell").find("[data-mu="+event_id+"]").trigger("click")}),$("div.table-scroller").bind("mousedown touchstart",function(){scrollCaptain=$(this)}),$("div.table-scroller").on("scroll",function(){var e=$(this);return e.scrollLeft()!=scrollX&&e.is(scrollCaptain)?(scrollX=e.scrollLeft(),void $.each(scrollCache,function(t,a){a[0].is(e)||a[0].scrollLeft(e.scrollLeft()),a[0].scrollLeft()>=a[1].width()-a[0].width()-5?(a[3].css("width",0+(a[1].width()-a[0].width()-a[0].scrollLeft())),a[3].data("scrollRightVis",!1)):a[3].data("scrollRightVis")===!1&&(a[3].css("width","5px"),a[3].data("scrollRightVis",!0)),a[0].scrollLeft()<=5?(a[2].css("width",0+a[0].scrollLeft()),a[2].data("scrollLeftVis",!1)):a[2].data("scrollLeftVis")===!1&&(a[2].css("width","5px"),a[2].data("scrollLeftVis",!0))})):!1}),$(function(){$("ul.dropdown li").hover(function(){$(this).addClass("hover"),$("ul:first",this).css("visibility","visible")},function(){$(this).removeClass("hover"),$("ul:first",this).css("visibility","hidden")}),$("ul.dropdown li").click(function(e){$(e.toElement).is("#format-amount-box1")||($(this).hasClass("hover")?($(this).removeClass("hover"),$("ul:first",this).css("visibility","hidden")):($(this).addClass("hover"),$("ul:first",this).css("visibility","visible")))}),$("ul.dropdown li ul li").click(function(){})}),$(".share-area").click(function(e){var t=$(this).parent().find(".share-window");$(t).addClass("show"),$(t).find(".share-item").on("click",function(e){"whatsapp://"==$(this).data("href").substring(0,11)?window.location.href=$(this).data("href"):window.open(""+$(this).data("href"),"_blank")}),shareVisible=!0}),$("#chart-window").on("click",function(e){($(e.target).is(".cd-popup-close")||$(e.target).is("#chart-window"))&&(e.preventDefault(),$(this).removeClass("is-visible"),$("#chart-area").empty())}),$("#alert-window").on("click",function(e){($(e.target).is(".cd-popup-close")||$(e.target).is("#alert-window"))&&(e.preventDefault(),$(this).removeClass("is-visible"))}),$(document).keyup(function(e){"27"==e.which&&($("#chart-window").removeClass("is-visible"),$("#chart-area").empty())}),$(document).click(function(e){$(e.target).closest("#chart-window").length||$("#chart-window").is(":visible")&&($("#chart-window").removeClass("is-visible"),$("#chart-area").empty()),$(e.target).closest("#alert-window").length||$("#alert-window").is(":visible")&&$("#alert-window").removeClass("is-visible"),shareVisible===!0&&($(e.target).closest(".share-button").length||$(e.target).closest(".share-item").length||($("div.share-window.show").removeClass("show"),shareVisible=!1,$(".share-item").off("click")))}),$("a.but-sg").on("click",function(e){var t=$.parseJSON($(this).attr("data-li"));if(parlayMode)return addToParlay(this);var a=$(this).parent().parent().find("th").find("a").text()+' <span style="font-weight: normal;"> &#150; <a href="'+$(this).closest("table").find("th").eq($(this).parent().index()).find("a").attr("href")+'" target="_blank">'+$(this).closest("table").find("th").eq($(this).parent().index()).find("a").text()+"</a></span>";return chartCC(),createMChart(t[0],t[1],t[2]),chartSC(a,e.clientX,e.clientY),!1}),$("a.but-sgp").on("click",function(e){var t=$.parseJSON($(this).attr("data-li"));if(parlayMode)return addToParlay(this);var a=$(this).parent().parent().find("th").text()+' <span style="font-weight: normal;"> &#150; <a href="'+$(this).closest("table").find("th").eq($(this).parent().index()).find("a").attr("href")+'" target="_blank">'+$(this).closest("table").find("th").eq($(this).parent().index()).find("a").text()+"</a></span>";return chartCC(),createPChart(t[0],t[2],t[1],t[3],t[4]),chartSC(a,e.clientX,e.clientY),!1}),$("a.but-sgep").on("click",function(e){var t=$.parseJSON($(this).attr("data-li"));if(parlayMode)return addToParlay(this);var a=$(this).parent().parent().find("th").text()+' <span style="font-weight: normal;"> &#150; <a href="'+$(this).closest("table").find("th").eq($(this).parent().index()).find("a").attr("href")+'" target="_blank">'+$(this).closest("table").find("th").eq($(this).parent().index()).find("a").text()+"</a></span>";return chartCC(),createEPChart(t[0],t[1],t[2],t[3]),chartSC(a,e.clientX,e.clientY),!1}),$("a.but-si").on("click",function(e){var t=$.parseJSON($(this).attr("data-li"));if(parlayMode)return!1;var a=$(this).parent().parent().find("th").text()+' <span style="font-weight: normal;"> &#150; Mean odds';return chartCC(),createMIChart(t[1],t[0]),chartSC(a,e.clientX,e.clientY),!1}),$("a.but-sip").on("click",function(e){var t=$.parseJSON($(this).attr("data-li"));if(parlayMode)return!1;var a=$(this).parent().parent().find("th").text()+' <span style="font-weight: normal;"> &#150; Mean odds';return chartCC(),createPIChart(t[1],t[0],t[2],t[3]),chartSC(a,e.clientX,e.clientY),!1}),$("a.but-siep").on("click",function(e){var t=$.parseJSON($(this).attr("data-li"));if(parlayMode)return!1;var a=$(this).parent().parent().find("th").text()+' <span style="font-weight: normal;"> &#150; Mean odds';return chartCC(),createEPIChart(t[0],t[1],t[2]),chartSC(a,e.clientX,e.clientY),!1}),$("a.but-al").on("click",function(e){var t={};return t.opts=$.parseJSON($(this).attr("data-li")),t.bestodds=$(this).closest("tr").find(".bestbet").first().text(),t.teamtitle=$(this).closest("tr").find("th").text(),parlayMode?addToParlay(this):(alertSW(t,e.clientX,e.clientY),!1)})},addAlert=function(e,t,a,s,i,r){},refreshPage=function(){$("#content").load("api?f=rp",function(){initPage(),$.each(refreshOpenProps,function(e,t){t===!0&&$('a[data-mu="'+e+'"]').first().trigger("click")})})},updateLine=function(e,t){},toggleRefresh=function(e){e===!0?(refreshId=setInterval(function(){refreshPage()},12e4),$("#autoRefresh").addClass("refresh-ind-spin"),Cookies.set("bfo_autorefresh",1,{expires:999})):($("#autoRefresh").removeClass("refresh-ind-spin"),Cookies.set("bfo_autorefresh",0,{expires:999}),"undefined"!=typeof refreshId&&clearInterval(refreshId))},throttle=function(e,t,a){t||(t=250);var s,i;return function(){var r=a||this,o=+new Date,n=arguments;s&&s+t>o?(clearTimeout(i),i=setTimeout(function(){s=o,e.apply(r,n)},t)):(s=o,e.apply(r,n))}},debounce=function(e,t){var a=null;return function(){var s=this,i=arguments;clearTimeout(a),a=setTimeout(function(){e.apply(s,i)},t)}},$(function(){FastClick.attach(document.body)}),fightSelected=function(){fightID=$("#webFight")[0].options[$("#webFight")[0].selectedIndex].value,ftitle=$("#webFight")[0].options[$("#webFight")[0].selectedIndex].text.trim(),0!==fightID?(imageLink="",type="","opening"==$('[name="webLineType"]:checked').val()&&(type+="_o"),"2"==$('[name="webLineFormat"]:checked').val()&&(type+="_d"),fightID>0?imageLink="fights/"+fightID+type+".png":fightID<0&&(imageLink="events/"+Math.abs(fightID)+type+".png"),$('[name="webTestImage"]')[0].src="/img/loading.gif",$("#webHTML").val('<!-- Begin BestFightOdds code -->\n<a href="https://www.bestfightodds.com" target="_blank"><img src="https://www.bestfightodds.com/'+imageLink+'" alt="'+ftitle+' odds - BestFightOdds" style="width: 216px; border: 0;" /></a>\n<!-- End BestFightOdds code -->'),$("#webForum").val("[url=https://www.bestfightodds.com][img]https://www.bestfightodds.com/"+imageLink+"[/img][/url]"),$('[name="webTestImage"]')[0].src=""+imageLink,$("#webImageLink").val("https://www.bestfightodds.com/"+imageLink),$("#webFields").css({display:""})):$("#webFields").css({display:"none"})},document.oncopy=hideArrows;
function createMChart(e,t,a){$.get("/api?f=ggd&b="+e+"&m="+a+"&p="+t,function(e){createChart($.parseJSON(notIn(e)))})}function createMIChart(e,t){$.get("/api?f=ggd&m="+e+"&p="+t,function(e){createChart($.parseJSON(notIn(e)))})}function createPChart(e,t,a,n,i){$.get("/api?f=ggd&b="+e+"&m="+t+"&p="+a+"&pt="+n+"&tn="+i,function(e){createChart($.parseJSON(notIn(e)))})}function createPIChart(e,t,a,n){$.get("/api?f=ggd&m="+e+"&p="+t+"&pt="+a+"&tn="+n,function(e){createChart($.parseJSON(notIn(e)))})}function createEPChart(e,t,a,n){$.get("/api?f=ggd&b="+t+"&e="+e+"&p="+a+"&pt="+n,function(e){createChart($.parseJSON(notIn(e)))})}function createEPIChart(e,t,a){$.get("/api?f=ggd&e="+e+"&p="+t+"&pt="+a,function(e){createChart($.parseJSON(notIn(e)))})}function createChart(e){Highcharts.setOptions({global:{useUTC:!1}}),$("#chart-area").highcharts({chart:{type:"line",style:{fontFamily:"'Roboto', Arial, sans-serif"},marginTop:18},credits:{enabled:!1},legend:{enabled:!1},colors:["#393B42"],title:{text:"",style:{color:"#272727",fontSize:"12px",fontWeight:"bold"}},xAxis:{type:"datetime",dateTimeLabelFormats:{month:"%e. %b",year:"%b"},title:{text:""},tickPixelInterval:50},yAxis:{title:{text:""},labels:{formatter:function(){return this.value>1?2==oddsType?Highcharts.numberFormat(this.value,2):4==oddsType?(odds=5*Math.round(oneDecToML(this.value)/5),singleMLToFractional(odds)):oneDecToML(this.value):""}},tickPixelInterval:50},tooltip:{formatter:function(){var e=this.series.xData.indexOf(this.x),t=(this.series.yData[e-1],"");"undefined"!=typeof this.series.yData[e-1]&&(this.series.yData[e-1]<this.y?t='<span style="color: #4BCA02">▲</span>':this.series.yData[e-1]>this.y&&(t='<span style="color: #E93524">▼</span>'));var a;return 2==oddsType?a=Highcharts.numberFormat(this.y,2):4==oddsType?(odds=5*Math.round(oneDecToML(this.y)/5),a=singleMLToFractional(odds)):a=oneDecToML(this.y),'<span style="color: #666; font-weight: bold; font-size: 11px">'+Highcharts.dateFormat("%a %d. %b %H:%M",this.x)+"</span><br/>"+this.series.name+": <b>"+a+"</b>"+t+"<br/>"},style:{fontSize:"12px"}},plotOptions:{series:{step:"left",animation:!1},line:{turboThreshold:1500,lineWidth:1.75,marker:{enabled:!1,fillColor:"#666",radius:2},states:{hover:{lineWidth:1.75}},dataLabels:{shape:"callout",defer:!1,enabled:!0,formatter:function(){return 0===this.point.index||this.series.chart.series[0].points.length-1==this.point.index?2==oddsType?'<span style="margin-left: 4px; margin-right: 4px;">'+Highcharts.numberFormat(this.y,2)+"</span>":4==oddsType?(odds=5*Math.round(oneDecToML(this.y)/5),'<span style="margin-left: 4px; margin-right: 4px;">'+singleMLToFractional(odds)+"</span>"):'<span style="margin-left: 4px; margin-right: 4px;">'+oneDecToML(this.y)+"</span>":null},backgroundColor:"rgba(69, 69, 69, 0.8)",padding:3,style:{textShadow:0,fontSize:"11px",color:"#fff",fontWeight:"normal"},y:-8,overflow:"none",crop:!1,useHTML:!0}}},series:e})}$(function(){function e(e){for(var t=e[0].data,a=[],n=0;n<t.length;n++)a.push(t[n][0]);var i=10;t.length<10&&(i=t.length),$("#event-swing-container").highcharts({title:{text:""},legend:{enabled:!1},chart:{animation:!1,type:"bar",style:{fontFamily:"'Roboto', Arial, sans-serif",color:"#1a1a1a",fontSize:"10px",fontWeight:"500"},spacingBottom:3},xAxis:{categories:a,labels:{overflow:"justify",style:{fontSize:"10px",fontWeight:"500",align:"left"}},max:i-1,crosshair:{color:"#eaeaea"}},yAxis:{title:"",labels:{style:{color:"#aaacae"}}},tooltip:{valueSuffix:" %"},plotOptions:{bar:{dataLabels:{formatter:function(){return this.y>0?"+"+this.y+"%":this.y+"%"},style:{fontFamily:"'Roboto', Arial, sans-serif",color:"#4d4d4d",fontSize:"11px",fontWeight:"500"},enabled:!0,crop:!1,overflow:"none",allowOverlap:!0}},series:{animation:{duration:200},color:"#606060",pointPadding:0,groupPadding:.2}},credits:{enabled:!1},series:e})}if(document.getElementById("event-swing-container")){$("#event-swing-container").data("expanded",!1),$("#event-swing-container").data("series",0);var t=$.parseJSON($("#event-swing-container").attr("data-moves"));e(t)}}),$(function(){function e(e){for(var t=e.data,a=[],n=[],i=[],s=[],r=[],o=[],l=[],c=0;c<t.length;c++)a.push(t[c][0][0]),n.push(t[c][0][1]),i.push(-t[c][1][0]),s.push(-t[c][1][1]),r.push(t[c][1][2]),o.push(t[c][1][3]),l.push(t[c][1][4]);$("#event-outcome-container").highcharts({chart:{type:"bar",style:{fontFamily:"'Roboto', Arial, sans-serif",color:"#1a1a1a",fontSize:"10px",fontWeight:"500"}},title:{text:""},xAxis:[{categories:a,reversed:!0,labels:{overflow:"justify",style:{fontSize:"10px",fontWeight:"500",align:"left"}}},{opposite:!0,reversed:!0,categories:n,linkedTo:0,labels:{overflow:"justify",style:{fontSize:"10px",fontWeight:"500",align:"left"}},style:{fontFamily:"'Roboto', Arial, sans-serif",color:"#1a1a1a",fontSize:"10px",fontWeight:"500"}}],yAxis:{title:{text:""},labels:{style:{color:"#aaacae"},formatter:function(){return Math.abs(this.value)}}},tooltip:{formatter:function(){var e="";if(0==this.points[0].y&&0==this.points[1].y&&0==this.points[2].y&&0==this.points[3].y&&0==this.points[4].y)return!1;for(var t=0;t<this.points.length;t++)e+="Draw"==this.points[t].series.name?'<span style="font-weight: 400; color: '+this.points[t].series.color+'">Draw: <b>'+Math.round(Math.abs(this.points[t].percentage))+"%</b><br />":this.points[t].percentage<0?'<span style="font-weight: 400; color: '+this.points[0].series.color+'">'+this.points[t].series.chart.xAxis[0].categories[this.points[t].point.x]+" by "+this.points[t].series.name.charAt(0).toLowerCase()+this.points[t].series.name.slice(1)+": <b>"+Math.round(Math.abs(this.points[t].percentage))+"%</b><br />":'<span style="font-weight: 400; color: '+this.points[0].series.color+'">'+this.points[t].series.chart.xAxis[1].categories[this.points[t].point.x]+" by "+this.points[t].series.name.charAt(0).toLowerCase()+this.points[t].series.name.slice(1)+": <b>"+Math.round(Math.abs(this.points[t].percentage))+"%</b><br />";return e},shared:!0},plotOptions:{bar:{stacking:"percent",borderWidth:0,dataLabels:{formatter:function(){return""},enabled:!0,style:{fontSize:"9px",textShadow:"0 0 1px black"}},animation:!1},series:{pointPadding:0,groupPadding:.2}},credits:{enabled:!1},legend:{itemStyle:{fontFamily:"'Roboto', Arial, sans-serif",color:"#2a2a2a",fontSize:"11px",fontWeight:"500"}},series:[{name:"Decision",data:l,color:"#303030",legendIndex:5},{name:"Finish",data:o,color:"#606060",legendIndex:4},{name:"Draw",data:r,color:"#a30000",legendIndex:3},{name:"Decision",data:i,color:"#c0c0c0",legendIndex:1},{name:"Finish",data:s,color:"#a0a0a0",legendIndex:2}]})}if(document.getElementById("event-outcome-container")){var t=$.parseJSON($("#event-outcome-container").attr("data-outcomes"));e(t)}}),$(function(){function e(e){for(var t=[],a=0;a<e.length;a++)t.push(e[a].name);return t}function t(e){var t=e.highcharts();if(0==e.data("expanded")){var a=10;t.series[e.data("series")].data.length<10&&(a=t.series[e.data("series")].data.length),t.xAxis[0].setExtremes(null,a-1)}else t.xAxis[0].setExtremes(null,t.series[e.data("series")].data.length-1)}function a(e){var t=$("#event-swing-container"),a=t.highcharts();t.css("height",50+18*(a.xAxis[0].getExtremes().max+1)),1==t.data("expanded")?($(".event-swing-expand").find("div").css("background-image","url(/img/expu.png)"),$(".event-swing-expand").find("span").text("Show less")):($(".event-swing-expand").find("div").css("background-image","url(/img/expd.png)"),$(".event-swing-expand").find("span").text("Show all")),a.setSize(a.chartWidth,50+18*(a.xAxis[0].getExtremes().max+1)),a.redraw()}$(".event-swing-picker").click(function(){var n=$(this).attr("data-li"),i=$("#event-swing-container"),s=i.highcharts();if(n==i.data("series"))return!1;i.data("series",n),s.series[n].data.length<10&&i.data("expanded",!i.data("expanded"));for(var r,o=s.series,l=o.length;l--;)r=o[l],l!=n&&r.hide();return o[n].show(),cats=e(s.series[n].data),s.xAxis[0].setCategories(cats),t(i),a(s.series[n].data),$(".event-swing-picker").removeClass("picked"),$(this).addClass("picked"),!1}),$(".event-swing-expand").click(function(){var n=$("#event-swing-container"),i=n.highcharts();return n.data("expanded",!n.data("expanded")),cats=e(i.series[n.data("series")].data),i.xAxis[0].setCategories(cats),t($("#event-swing-container")),a(i.series[n.data("series")].data),!1})}),$(function(){function e(){var n,i,s,r,o,l,c=+new Date,h=t.length;for(n=0;h>n;n+=1)if(i=$(t[n]),s=i.data("sparkline"),r=s.split("; "),o=$.map(r[0].split(", "),parseFloat),l={},r[1]&&(l.type=r[1]),i.highcharts("SparkLine",{series:[{data:o,pointStart:1}],chart:l}),a+=1,new Date-c>500){t.splice(0,n+1),setTimeout(e,0);break}}Highcharts.SparkLine=function(e,t){var a={chart:{renderTo:e.chart&&e.chart.renderTo||this,backgroundColor:null,borderWidth:0,type:"area",margin:[3,0,5,2],width:50,height:32,className:"chart-spark",events:{click:function(e){var t=$.parseJSON($("#"+this.container.id).closest("td").attr("data-li")),a=$("#"+this.container.id).closest("tr").next("tr").find("th.oppcell").text(),n=$("#team-name").text()+' <span style="font-weight: normal;">(vs. '+a+") &#150; Mean odds";chartCC(),createMIChart(t[0],t[1]),chartSC(n,e.clientX,e.clientY)}},style:{overflow:"visible"},skipClone:!0},colors:["#000"],title:{text:""},credits:{enabled:!1},xAxis:{labels:{enabled:!1},title:{text:null},startOnTick:!1,endOnTick:!1,tickPositions:[]},yAxis:{endOnTick:!1,startOnTick:!1,labels:{enabled:!1},title:{text:null},tickPositions:[0]},legend:{enabled:!1},tooltip:{enabled:!1},plotOptions:{series:{threshold:null,animation:!1,lineWidth:.65,states:{hover:{enabled:!1}},shadow:!1,events:{click:function(e){var t=$.parseJSON($("#"+this.chart.container.id).closest("td").attr("data-li")),a=$("#"+this.chart.container.id).closest("tr").next("tr").find("th.oppcell").text(),n=$("#team-name").text()+' <span style="font-weight: normal;">(vs. '+a+") &#150; Mean odds";chartCC(),createMIChart(t[0],t[1]),chartSC(n,e.clientX,e.clientY)}},marker:{enabled:!1},fillColor:"#e9ebed"}}};return e=Highcharts.merge(a,e),new Highcharts.Chart(e,t)};var t=(+new Date,$("td[data-sparkline]")),a=(t.length,0);e()});