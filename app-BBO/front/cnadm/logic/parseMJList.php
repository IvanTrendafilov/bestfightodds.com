...
echo '<div style="width: 400px;"><form method="post" action="../logic/logic.php?action=addMultipleFights" style="border: 0; padding:0; margin: 0; float: right;"><input type="hidden" name="eventID" value="'  . $iEventID . '" /><input type="hidden" name="fights" value="' . $sAllMatchups . '" /><a href="#" onclick="submit()">add all</a></form><br /></div>';
