...
<div id="page-wrapper">
    ...
    <div id="page-container">
        ...
        <div class="content-sidebar">
            <p>
                <img src="img/info.gif" class="img-info-box" /> All odds posted on the site is stored in the archive. The archive contains thousands of matchups and fighter profiles dating back to 2007 when the site was first launched.
            </p>
        </div>
        <div class="clear"></div>
    </div>
