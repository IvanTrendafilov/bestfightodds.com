...
class OddsProcessor
{
    ...
    private function updateOneMatchedMatchup($matched_matchup)
    {
        ...
        if ($event != null)
        {
            ...
            {
                if ($this->bookie_id != 12  && $this->bookie_id != 5 && $this->bookie_id != 17 && $this->bookie_id != 4) //TODO: Temporary disable BetOnline, Bovada, William Hill, Sportsbook from storing metadata
                {
