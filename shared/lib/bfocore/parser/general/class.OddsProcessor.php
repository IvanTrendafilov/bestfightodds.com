...
class OddsProcessor
{
    ...
    private function updateOneMatchedMatchup($matched_matchup)
    {
        ...
        if ($event != null)
        {
            ...
            {
                if ($this->bookie_id != 12  && $this->bookie_id != 5 && $this->bookie_id != 17 && $this->bookie_id != 4 && $this->bookie_id != 19 && $this->bookie_id != 18) //TODO: Temporary disable BetOnline, Bovada, William Hill, Sportsbook, Bet365, Intertops from storing metadata
                {
