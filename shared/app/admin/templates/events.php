            ...
            <form class="w-full max-w-xl">
                <div class="flex flex-wrap -mx-3 ">
                    <div class="w-full md:w-1/2 px-3 md:mb-0">
                        ...
                        <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-red-500 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" id="event_name" type="text" placeholder="UFC Fight Night" value="<?= $in_event_name ?>">
                    </div>
