...
define('IMAGE_CACHE_DIR', 'G:\\Dev\\www\\bfo\\app\\front\\img\\cache\\');  //Image Cache Directory
define('CACHE_IMAGE_CACHE_ENABLED', false); //Enables/disables cache for graphs. Should only be disabled during development

define('CACHE_PAGE_DIR', 'G:\\Dev\\www\\bfo\\app\\front\\pages\\cache\\');  //Page Cache Directory
