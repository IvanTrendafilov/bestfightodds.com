...
function updateBookieColumns() {
    ...
    if (document.querySelector('.table-scroller')) {
        ...
        if (current_settings !== null) {
            ...
            //Validate integrity of stored order. It will not be valid if any bookie has been removed or added
            var abort = false;
            remapped.forEach(function (item) {
                if (document.querySelectorAll('.table-scroller')[0].querySelector('th[data-b="' + item + '"]') === null) {
                    abort = true;
                }
            });
