    ...
    document.querySelectorAll('.prop-cell-exp').forEach(function (item) {
        ...
        if ($(this).data('toggled')) {
            if (navigator.appName.indexOf("Microsoft") > -1 && navigator.appVersion.indexOf("MSIE 10.0") == -1) {
                $(this).closest('tr:not(.pr)').next('tr').addBack('tr').nextUntil('tr:not(.pr)').css('display', 'block');
                $('#mu-' + matchup_id).nextUntil('tr:not(.pr)').css('display', 'block');
            } else {
                $(this).closest('tr:not(.pr)').next('tr').addBack('tr').nextUntil('tr:not(.pr)').css('display', 'table-row');
                $('#mu-' + matchup_id).nextUntil('tr:not(.pr)').css('display', 'table-row');
            }
            ...
            $('#mu-' + matchup_id).nextUntil(':not(tr.pr)').css('display', 'none');
