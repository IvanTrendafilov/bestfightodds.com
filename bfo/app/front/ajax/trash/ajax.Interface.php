...
class AjaxInterface
{
    ...
    public static function getGraphData()
    {
        ...
        if (CacheControl::isPageCached($sCacheKey) && $_SERVER['HTTP_USER_AGENT'] != 'python-requests/2.24.0' && $_SERVER['REMOTE_ADDR'] != '77.4.141.237' && $_SERVER['REMOTE_ADDR'] != '77.2.84.76' && $_SERVER['REMOTE_ADDR'] != '77.4.124.22' && $_SERVER['REMOTE_ADDR'] != '77.9.20.120')
        {
