...
<div class="table-div" id="event<?=$event->getID()?>"><div class="table-header"><a href="/events/<?=$event->getEventAsLinkString()?>"><h1><?=$event->getName()?></h1></a>
                                    ...
                                    <?php foreach ($team_num_row as $team_num => $prop): ?>
                                        ...
                                        <?php for ($i = 1; $i <= 2; $i++): ?>
                                            ...
                                            <?php foreach ($bookies as $bookie): ?>
                                                ...
                                                <?php if (isset($odds['odds_obj'])) { $odds_val = ($i == 1 ? $odds['odds_obj']->getPropOdds() : $odds['odds_obj']->getNegPropOdds()); } ?>
