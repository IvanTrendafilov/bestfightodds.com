...
cd $backupdir/
mysqldump -h ls-9bf1268dd5beed1d539ee8d4c86139bf072394e4.cc2cczpln4tj.us-east-2.rds.amazonaws.com --routines -ubfo -pf9CtzD4AyG9hVfgnodb9 bets > $backupdir/$backupfilename.sql
echo 'Dump complete'
