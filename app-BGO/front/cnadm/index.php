...
<title>Admin</title>
<?php
//Only include javascripts and autocomplete css if trying to add a fight or a prop template
if (isset($_GET['p']) && ($_GET['p'] == 'addNewFightForm' || $_GET['p'] == "addNewPropTemplate"))
{
?>
