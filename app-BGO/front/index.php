    ...
    switch ($_GET['p'])
    {
        ...
        case 'fighter':
            ...
            if ($oFighter != null)
            {
                ...
                define('PAGE_OVERRIDE_DESCRIPTION', 'Betting odds history for ' . $oFighter->getNameAsString() . '.');
        ...
        case 'event':
            ...
            if ($oEvent != null)
            {
                define('PAGE_OVERRIDE_TITLE', $oEvent->getName() . ' Odds');
                define('PAGE_OVERRIDE_DESCRIPTION', 'Betting odds for ' . $oEvent->getName() . '.');
        ...
        case 'matchup':
            ...
            if ($oMatchup != null)
            {
                define('PAGE_OVERRIDE_TITLE', $oMatchup->getTeamAsString(1) . ' vs. ' . $oMatchup->getTeamAsString(2) . ' Odds');
                define('PAGE_OVERRIDE_DESCRIPTION', 'Betting odds for ' . $oMatchup->getTeamAsString(1) . ' vs. ' . $oMatchup->getTeamAsString(2) . '.');
